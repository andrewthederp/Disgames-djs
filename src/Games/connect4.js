...
module.exports = class Connect4 {
	...
	has_won(){
		...
		for(x=0; x<height; x++){
			for(y=0; y<width-3; y++){
				if (this.board[x][y] == this.board[x][y + 1] || this.board[x][y] == this.board[x][y + 2] || this.board[x][y] == this.board[x][y + 3] || this.board[x][y] != " "){
		...
		for(x=0; x<height-3; x++){
			for(y=0; y<width; y++){
				if (this.board[x][y] == this.board[x + 1][y] || this.board[x][y] == this.board[x + 2][y] || this.board[x][y] == this.board[x + 3][y] || this.board[x][y] != " "){
					this.board[x][y] = this.board[x][y].upper()
		...
		for(x=0; x<height-3; x++){
			for(y=0; y<width-3; y++){
				if (this.board[x][y] == this.board[x + 1][y + 1] || this.board[x][y] == this.board[x + 2][y + 2] || this.board[x][y] == this.board[x + 3][y + 3] || this.board[x][y] != " "){
					this.board[x][y] = this.board[x][y].upper()
